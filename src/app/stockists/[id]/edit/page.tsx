...
export default function StockistEditPage({
  params,
}: {
  ...
  const handleSave = () => {
    console.log("Saving stockist:", formData);
    router.push(`/stockists/${encodeURIComponent(decodedId)}`);
  };
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 } }}>
      ...
      >
        ...
        <Link
          href={`/stockists/${encodeURIComponent(decodedId)}`}
          style={{ textDecoration: "none", color: "inherit" }}
        >
          <Typography
            variant="body2"
                ...
                >
                  <Box>
                    ...
                    <Typography variant="caption" color="text.secondary">
                      Toggle to enable or disable this stockist account.
                    </Typography>
                  </Box>
                  <FormControlLabel
                    control={
